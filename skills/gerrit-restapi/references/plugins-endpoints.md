...
> **English Title**: Plugins REST API Endpoints
>
> 本文档为 Gerrit 插件，包含完整的 REST API 端点说明、请求/响应示例。
>
> **版本**: v3.8.3
...
- [Get Plugin Status](#get-plugin-status)
...
This page describes the plugin related REST endpoints. Please also take note of the general information on the [REST API](rest-api.html).
...
Disabling of a [mandatory plugin](config-gerrit.html#plugins.mandatory) is rejected:
