...
**jenkins_analysis**：同理，四阶段流程和 JSON 信封表移出：
...
**bug_analysis**（9KB）：JSON 信封示例可移到 references/。
...
| Skill | 脚本数 | 测试文件数 |
|---|---|---|
| jenkins_analysis | 3（collect / fetch / report）| 3 |
| gerrit_analysis | 0 | 0 |
...
| P2 | gerrit_analysis 加 analyze.py | 3-5h | 可测试性 + 可靠性 |
